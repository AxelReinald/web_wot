...
class CustomDropdownPhone extends StatefulWidget {
  ...
  final String? Function(String?)? validator, onChanged, onAction, test;
  ...
  const CustomDropdownPhone(
      ...
      : super(key: key);
  @override
  _CustomDropdownPhoneState createState() => _CustomDropdownPhoneState();
}
  ...
  Widget build(context) {
    return TypeAheadFormField(
      ...
      onSuggestionSelected: (suggestion) {
        setState(() {
          AutoData data = suggestion as AutoData;
          widget.controller!.text = data.mobileNo!;
          expanded = false;
