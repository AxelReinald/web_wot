...
class UploadPro extends StatefulWidget {
  const UploadPro({Key? key}) : super(key: key);

  @override
  State<UploadPro> createState() => _UploadProState();
}

class _UploadProState extends State<UploadPro>
  ...
  Future dropzoneresult(ev) async {
    ...
    bloc.add(UploadProFile(droppedFile));
  }
  ...
  void uploadSelectedFile() async {
    ...
    final request = http.MultipartRequest(
      "POST",
      Uri.parse(
          "http://192.168.0.130:9013/temacs/api/temacs/main/v1/uploadProvince"),
    );
