...
class ImportRole extends StatefulWidget {
  const ImportRole({Key? key}) : super(key: key);

  @override
  State<ImportRole> createState() => _ImportRoleState();
}

class _ImportRoleState extends State<ImportRole>
  ...
  void uploadSelectedFiles() async {
    ...
    final request = http.MultipartRequest(
      "POST",
      Uri.parse(
          "http://192.168.0.130:9017/temacs/api/temacs/main/v1/uploadRole"),
    );
  ...
  Future dropzoneresult(ev) async {
    ...
    bloc.add(UploadRole(droppedFile));
  }
