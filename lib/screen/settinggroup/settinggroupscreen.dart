...
class _MyWidgetState extends State<MyWidget>
  ...
  List<RData> listDtl = [RData(isChecked: false)];
  @override
  void initState() {
  ...
  final ScrollController contentScroll = ScrollController();
